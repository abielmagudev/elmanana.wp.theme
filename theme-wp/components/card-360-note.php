...
$note = (object) array(
    ...
    'icon_color' => isset($post_icon_color) ? $post_icon_color : 'red',
);

?>
<div class="position-relative">
    <article class="card text-white border-0 rounded-0" style="background-color:black">
        <div class="card-top-image" style="background-image:url('<?= $note->image ?>');background-size:cover;backdrop-filter: grayscale(0.5) !important;">
        ...
        <div class="position-absolute" style="top:2%;left:3%">
            <i class="fab fa-youtube fa-2x" style="color:<?= $note->icon_color ?>"></i>
        </div>
    </article>
</div>
